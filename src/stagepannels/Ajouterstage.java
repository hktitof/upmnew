...
public class Ajouterstage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(txt_startDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 150, 30));
        add(txt_endDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 150, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String debut=txt_startDate.getText();
        String fin=txt_endDate.getText();
