...
public class Suipprimerencad extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jButton1);
        jButton1.setBounds(430, 360, 100, 30);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(40, 200, 480, 150);
        ...
        add(jButton2);
        jButton2.setBounds(320, 360, 100, 30);
        ...
        add(jTextField4);
        jTextField4.setBounds(240, 80, 160, 30);
        ...
        add(jTextField1);
        jTextField1.setBounds(40, 80, 170, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/home_page/Framed deletee.jpg"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if(result.next()){
                jTextField1.setText(result.getString("nomEnca"));
                jTextField4.setText(result.getString("mailEnca"));
                jTextField2.setText(result.getString("teleEnca"));
                jTextField3.setText(result.getString("nvHierarchique"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Suipprimerencad.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int ligne=jTable1.getSelectedRow();
        String id= jTable1.getModel().getValueAt(ligne, 0).toString();
        String sql="delete from encadrent where idEnca='"+id+"'";
        try {
            st=cnx.prepareStatement(sql);
            st.execute();
            JOptionPane.showMessageDialog(null, "l'encadrent a été supprimé avec succès!");
        } catch (SQLException ex) {
            Logger.getLogger(Suipprimerencad.class.getName()).log(Level.SEVERE, null, ex);
        }
        UpdateTable();
